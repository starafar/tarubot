...
if (!process.env["TARUBOT_DISCORD_API_TOKEN"]) {
    throw new Error("No Discord API token was provided. Check your configuration in .env or environment variables.");
}
if (!process.env["TARUBOT_DISCORD_APP_ID"]) {
    throw new Error("No Discord app ID was provided. Check your configuration in .env or environment variables.");
}
if (process.env["TARUBOT_LOG_CONSOLE_ENABLED"] === "false" &&
    process.env["TARUBOT_LOG_FILE_ENABLED"] === "false") {
    throw new Error("No logging output was enabled. Check your configuration in .env or environment variables.");
}
if (!process.env["TARUBOT_DB_DIALECT"]) {
    throw new Error("No database dialect was provided. Check your configuration in .env or environment variables.");
}
export default {
    discord: {
        api: {
    ...
    db: {
        ...
        port: (process.env["TARUBOT_DB_PORT"] &&
